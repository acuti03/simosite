...
import First from '../../images/immobiliare_01.jpg'
import Second from '../../images/immobiliare_02.jpg'
import Third from '../../images/immobiliare_03.jpg'
        ...
        <>
            ...
            <Container>
                ...
                <Flex mt={3}>
                    ...
                    <Text mt='2px' ml={1}>A site that simulates a real estate agency. Built with php. I used sql to store various data.</Text>
                </Flex>
                <Flex mt={3}>
                ...
                <VStack mt={8} spacing={10}>
                    ...
                    <Image borderRadius={8} src={Third} border='1px solid' borderColor={dc}/>
                </VStack>
                <Footer/>
            </Container>
            </motion.div>
